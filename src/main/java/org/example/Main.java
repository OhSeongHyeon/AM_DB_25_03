...
public class Main {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        do {
                            ...
                            sb.append("작성일: ").append(AppUtil.localDateTimeParser(regDate)).append("\n");
                            sb.append("수정일: ").append(AppUtil.localDateTimeParser(updateDate)).append("\n");
    ...
    private static void connFinally(ResultSet rs, PreparedStatement pstmt, Connection conn) {
        try {
